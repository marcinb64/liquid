...
// TODO redesign GPIO interrupts to allow more flexible PCINT to GPIO mapping; see PORT J and PCINT 9-15
...
enum class Timer16 {
    Timer1, Timer3, Timer4, Timer5, None
};
...
struct GpioSpec {
    ...
    constexpr GpioSpec(AvrGpioRegs &regs_, int pin_, Pwm16 pwm16_) : regs(regs_), pin(pin_), pwm16(pwm16_) {}
...
public:
    ...
    static auto makeTimer16(Timer16 num) -> AvrTimer16 { return AvrTimer16(timer16config[static_cast<int>(num)]); }
    ...
    struct Gpio {
        ...
        static constexpr GpioSpec A8 = {portK, 0};
        static constexpr GpioSpec A9 = {portK, 1};
        static constexpr GpioSpec A10 = {portK, 2};
        static constexpr GpioSpec A11 = {portK, 3};
        static constexpr GpioSpec A12 = {portK, 4};
        static constexpr GpioSpec A13 = {portK, 5};
        static constexpr GpioSpec A14 = {portK, 5};
        static constexpr GpioSpec A15 = {portK, 5};

        static constexpr GpioSpec D0 = {portE, 0};
        ...
        static constexpr GpioSpec D10 = {portB, 4};
        static constexpr GpioSpec D11 = {portB, 5, {Timer16::Timer1, COMA}};
        static constexpr GpioSpec D12 = {portB, 6, {Timer16::Timer1, COMB}};
        static constexpr GpioSpec D13 = {portB, 7, {Timer16::Timer1, COMC}};
        static constexpr GpioSpec D14 = {portJ, 1};
        static constexpr GpioSpec D15 = {portJ, 0};
        ...
        static constexpr GpioSpec D50 = {portB, 3};
        static constexpr GpioSpec D51 = {portB, 2};
        static constexpr GpioSpec D52 = {portB, 1};
        static constexpr GpioSpec D53 = {portB, 0};
    ...
    {
        assert(spec.pwm16.timer != Timer16::None && spec.pwm16.channel != CompareOutputChannel::None);
    ...
    static auto makeSquareWave(const GpioSpec &spec) -> SquareWaveImpl16
    {
        ...
        assert(spec.pwm16.timer != Timer16::None && spec.pwm16.channel == CompareOutputChannel::ChannelA);
